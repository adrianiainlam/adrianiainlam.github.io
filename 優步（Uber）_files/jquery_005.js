...
(function($) {
	...
	$.fn.player = function(options, functions) {
		...
		var defaults = {
            ...
            flashWidth: '100%',
			flashHeight: String(Math.ceil(this.parent().width()*0.5625))+"px",
			playerStyles : {
					'height' : '100%',
					'width' : '100%',
				},
		...
		*---------------------------------------------------------*/
		...
		return this.each(function(i) {
			...
			// If the player is wider than 300 add a class of player-wide to the container
			/*if(player.$html.width()>300) {
